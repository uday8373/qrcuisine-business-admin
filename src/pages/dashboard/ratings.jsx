...
//         searchQuery,
//       );
//       console.log("Ratings Data:", ratingsResult); // Log the result here
//       if (ratingsResult) {
//         setRatingsData(ratingsResult);
//         setMaxItems(ratingsResult.count);
//       }
//     } catch (error) {
...
//                                   color="blue-gray"
//                                   className="font-normal">
//                                   <Rating value={rating_star} readonly />
//                                 </Typography>
//                               </div>
//                             </div>
//                           </td>
                            ...
                            <div className="flex items-center gap-3">
                              <div className="flex flex-col">
                                <Typography
                                  ...
                                  {/* <Rating value={Number(rating_star)} readonly /> */}
                                </Typography>
                              </div>
                            </div>
                          </td>
